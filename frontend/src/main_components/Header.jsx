...
const Header = () => {
    ...
    return (
        <header className="w-full bg-blue-600 text-white shadow-md z-[400]">
            <div
                className="container mx-auto px-4 py-2 flex flex-col sm:flex-row sm:justify-between sm:items-center space-y-2 sm:space-y-0">
                ...
                <div
                    ...
                    {token ? (
                        <div
                        className="px-4 py-2 sm:px-4 sm:py-1 md:px-5 md:py-2 flex items-center justify-center space-x-2">
                        <button
